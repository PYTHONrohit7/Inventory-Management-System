...
class employeeClass:
    def __init__(self,root):
        ...
        #txt_empid=Entry(self.root,textvariable=self.var_gender,font=('goudy old style',15),bg='white').place(x=500,y=150,width=180)
        ...
        txt_empid=Entry(self.root,textvariable=self.var_contact,font=('goudy old style',15),bg='lightyellow').place(x=850,y=150,width=180)
        
        #------Row2--------
        lbl_name=Label(self.root,text='Name',font=('goudy old style',15),bg='white').place(x=50,y=190)
        lbl_dob=Label(self.root,text='Date of Bairth',font=('goudy old style',15),bg='white').place(x=350,y=190)
        lbl_doj=Label(self.root,text='Date of Join',font=('goudy old style',15),bg='white').place(x=750,y=190)
